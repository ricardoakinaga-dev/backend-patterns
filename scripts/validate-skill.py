...
def validate() -> dict:
    ...
    required = {
        ...
        "scripts/validate-phase-assurance.py",
        "scripts/validate-phase-1-2.py",
        "scripts/validate-benchmark.py",
        "scripts/tailor-benchmark.py",
        "scripts/run-context-efficiency.py",
        "scripts/run-routing-mutations.py",
        "scripts/run-behavioral-eval.py",
        "scripts/run-composition-eval.py",
        "scripts/run-response-mutations.py",
        "scripts/run-generalization-gates.py",
        "scripts/run-runtime-gates.py",
        "scripts/run-all-gates.py",
        "scripts/score-responses.py",
        "composition-contract.json",
        "tests/run_evals.py",
        "tests/run_known_bad.py",
        "tests/benchmark/rubric.json",
        "tests/benchmark/scenarios.json",
        "tests/benchmark/final-gauntlet.json",
        "tests/benchmark/relations.json",
        "tests/fixtures/response-oracles.json",
    }
